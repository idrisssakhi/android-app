...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView registreLater = (TextView) findViewById(R.id.signInLater);
        registreLater.setOnClickListener(new OnClickListener() {
            @Override
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            params.put("mailAdress", email);
            params.put("password", password);
            mAuthTask = new UserLoginTask(Api.URL_CONNEXION, params, CODE_POST_REQUEST);
            mAuthTask.execute();
        }
    }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!object.getBoolean("error")) {
                    ...
                    //ici il faut mettre la rederection et enregistrer l'utilisateur
                    JSONObject user = object.getJSONObject("user");
                    SharedPreferences pref = getSharedPreferences("loginData", MODE_PRIVATE);
                    SharedPreferences.Editor editor = pref.edit();
                    editor.putString("name", user.getString("userName"));
                    editor.putString("email", user.getString("mailAdress"));
                    editor.putString("password", user.getString("password"));
                    editor.putString("fonction", user.getString("fonction"));
                    ...
                    if(object.getString("message").equals("mot de passe errone")){
                        Toast.makeText(getApplicationContext(), object.getString("message"), Toast.LENGTH_SHORT).show();
